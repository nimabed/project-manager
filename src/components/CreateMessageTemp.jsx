export default function CreateMessageTemp() {
  return (
    <div className="relative flex flex-col space-y-2 items-center mx-auto top-1/3">
      ...
      <button className="py-2 px-4 bg-gray-900 text-xl text-gray-400 rounded-md cursor-pointer hover:bg-gray-900/80 mt-4">Create new project</button>
    </div>
  )
}